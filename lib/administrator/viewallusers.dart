...
//                 ),
//                 Expanded(
//                     child: StreamBuilder(stream: FirebaseFirestore.instance.collection(),builder: (context, snapshot) {
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          String username = users[index].get('name');
                          String count = users[index].get('count').toString();
                          return Usertile(
                              name: username, totalDonations: count);
