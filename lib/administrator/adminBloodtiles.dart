...
class AdminUrgentBloodtiles extends StatefulWidget {
  String location;
  String bloodType;
  String nOfUnits;
  String uid;
  AdminUrgentBloodtiles(
  ...
  @override
  State<AdminUrgentBloodtiles> createState() => _AdminUrgentBloodtilesState();
}

class _AdminUrgentBloodtilesState extends State<AdminUrgentBloodtiles> {
  @override
